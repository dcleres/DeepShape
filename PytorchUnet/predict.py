...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', '-i', metavar='INPUT', nargs='+',
                        help='filenames of input images', default= "test_set_images/") #required=True)
    ...
    in_files_path = args.input
    in_files = [f for f in listdir(in_files_path) if isfile(join(in_files_path, f))]
    ...
    for i, fn in enumerate(in_files):
        ...
        img = Image.open(in_files_path + fn)
