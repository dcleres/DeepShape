...
np.save('training_accuracy_SGD_softmax', training_accuracy)
np.save('validation_accuracy_SGD_softmax', validation_accurcy)

plt.plot(training_accuracy)
plt.plot(validation_accurcy)
plt.savefig('Conv3D - Polycubes-Grid_size32-CE-Softmax-SGD.png')
