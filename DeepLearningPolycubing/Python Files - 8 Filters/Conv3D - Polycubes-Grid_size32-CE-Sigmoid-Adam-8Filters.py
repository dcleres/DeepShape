...
#model = conv3DNet(grid_size, Noutputs, batch_size)
#model = conv3DNet(grid_size, Noutputs, batch_size)
model = UnetGenerator_3d(in_dim=1, out_dim=Noutputs, num_filter=8)
...
np.save('training_accuracy_Adam', training_accuracy)
np.save('validation_accuracy_Adam', validation_accurcy)

plt.plot(training_accuracy)
plt.plot(validation_accurcy)
plt.savefig('Conv3D - Polycubes-Grid_size32-CE-Sigmoid-Adam-8Filters.png')
plt.show()
