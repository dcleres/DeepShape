...
np.save('training_accuracy_RMS', training_accuracy)
np.save('validation_accuracy_RMS', validation_accurcy)

plt.plot(training_accuracy)
plt.plot(validation_accurcy)
plt.savefig('Conv3D - Polycubes-Grid_size32-CE-Sigmoid-RMS-8Filters.png')
plt.show()
