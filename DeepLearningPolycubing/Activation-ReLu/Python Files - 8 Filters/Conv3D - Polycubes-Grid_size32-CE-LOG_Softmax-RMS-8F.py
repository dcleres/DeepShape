...
np.save('training_accuracy_RMS_LOG_softmax', training_accuracy)
np.save('validation_accuracy_RMS_LOG_softmax', validation_accurcy)

plt.plot(training_accuracy)
plt.plot(validation_accurcy)
plt.savefig('Conv3D - Polycubes-Grid_size32-CE-LOG_Softmax-RMS.png')
