...
np.save('training_accuracy_SGD_LOG_softmax', training_accuracy)
np.save('validation_accuracy_SGD_LOG_softmax', validation_accurcy)

plt.plot(training_accuracy)
plt.plot(validation_accurcy)
plt.savefig('Conv3D - Polycubes-Grid_size32-CE-LOG_Softmax-SGD.png')
