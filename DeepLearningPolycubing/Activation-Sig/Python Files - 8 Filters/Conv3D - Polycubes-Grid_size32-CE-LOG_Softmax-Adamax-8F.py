...
model = UnetGenerator_3d_log_softmax(in_dim=1, out_dim=Noutputs, num_filter=8)
...
np.save('training_accuracy_Adamax_LOG_softmax', training_accuracy)
np.save('validation_accuracy_Adamax_LOG_softmax', validation_accurcy)

plt.plot(training_accuracy)
plt.plot(validation_accurcy)
plt.savefig('Conv3D - Polycubes-Grid_size32-CE-LOG_Softmax-Adamax.png')
