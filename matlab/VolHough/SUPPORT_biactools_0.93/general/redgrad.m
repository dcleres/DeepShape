function [cmap]=redgrad(n,startVal,stopVal)
%REDGRAD Generate colormap of red with increasing intensity.
%  REDGRAD(M,startVal,stopVal)
%
%    M - Colormap length (M-by-3) [default: length of current colormap]
%    startVal - lowest intensity (0 to 1) of red in colormap  [default: 0.3]
%    stopVal  - highest intensity (0 to 1) of red in colormap [default: 1.0]
%
%  See Also: COLORMAP

% CVS ID and authorship of this code
% CVSId = '$Id: redgrad.m,v 1.3 2005/02/03 16:58:35 michelich Exp $';
% CVSRevision = '$Revision: 1.3 $';
% CVSDate = '$Date: 2005/02/03 16:58:35 $';
% CVSRCSFile = '$RCSfile: redgrad.m,v $';
...
% Make the colormap
cmap=[[startVal:((stopVal-startVal)/(n-1)):stopVal]', zeros(n,1), zeros(n,1)];
