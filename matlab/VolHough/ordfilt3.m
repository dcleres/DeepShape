...
%M = feature('memstats');
M=1000000000; % feature('memstats') doesn't work on MATLAB for Mac, so
              % just tell it we have 1GB of contiguous memory.  (Should be
              % a reasonable assumption, esp. on recon engine)
